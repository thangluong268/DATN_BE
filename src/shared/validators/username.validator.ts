...
export function UsernameValidator(validationOptions?: ValidationOptions) {
  return function (object: object, propertyName: string) {
    ...
    Matches(/^[a-z][a-z0-9]{0,19}$/, {
      message:
        'username should start with a lowercase English letter and can contain lowercase letters and numbers only',
    })(object, propertyName);
    IsLowercase({ message: 'username should be in lowercase' })(
      object,
      propertyName,
    );
